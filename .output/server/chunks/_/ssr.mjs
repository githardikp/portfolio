import { createFileRoute, lazyRouteComponent, createRootRoute, useRouter, Outlet, HeadContent, Scripts, Link, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-CcQe9ZcU.mjs');
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxs(RootDocument, { children: [
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsx("main", { className: "container mx-auto px-4 py-8 min-h-screen", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ jsx(motion.div, { initial: {
      opacity: 0,
      y: 20
    }, animate: {
      opacity: 1,
...
function RootDocument({
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100", children: [
      children,
...
function Header() {
  return /* @__PURE__ */ jsx("header", { className: "bg-white/80 backdrop-blur border-b sticky top-0 z-50", children: /* @__PURE__ */ jsxs("nav", { className: "container mx-auto flex items-center gap-6 py-4 px-4", children: [
    /* @__PURE__ */ jsx("span", { className: "font-bold text-xl", children: "Your Name" }),
    /* @__PURE__ */ jsx("div", { className: "flex-1" }),
    /* @__PURE__ */ jsx(NavLink, { to: "/", children: "Home" }),
    /* @__PURE__ */ jsx(NavLink, { to: "/skills", children: "Skills" }),
    /* @__PURE__ */ jsx(NavLink, { to: "/projects", children: "Projects" }),
    /* @__PURE__ */ jsx(NavLink, { to: "/tools", children: "Tools" }),
    /* @__PURE__ */ jsx(NavLink, { to: "/dsa", children: "DSA Learning" }),
    /* @__PURE__ */ jsx(NavLink, { to: "/contact", children: "Contact" })
  ] }) });
}
function NavLink(props) {
  return /* @__PURE__ */ jsx(Link, { ...props, activeOptions: {
    exact: true
  }, activeProps: {
...
function Footer() {
  return /* @__PURE__ */ jsxs("footer", { className: "py-6 border-t text-center text-sm", children: [
    "© ",
    (/* @__PURE__ */ new Date()).getFullYear(),
    " Your Name — All rights reserved."
  ] });
}
const $$splitComponentImporter$6 = () => import('./tools-Cc8xcaIc.mjs');
const Route$6 = createFileRoute("/tools")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import('./skills-DT8Cj1iR.mjs');
const Route$5 = createFileRoute("/skills")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import('./projects-B2xtBwdn.mjs');
const Route$4 = createFileRoute("/projects")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./contact-CUV7N4Uo.mjs');
const Route$3 = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./index-smiVzk5w.mjs');
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import('./index-DZLZX8Ti.mjs');
const Route$1 = createFileRoute("/dsa/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./_problemId-BGaBf07X.mjs');
const Route = createFileRoute("/dsa/$problemId")({
...
const DsaIndexRoute = Route$1.update({
  id: "/dsa/",
  path: "/dsa/",
  getParentRoute: () => Route$7
});
const DsaProblemIdRoute = Route.update({
  id: "/dsa/$problemId",
  path: "/dsa/$problemId",
  getParentRoute: () => Route$7
});
